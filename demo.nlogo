...
to move
  ...
  ask defence with [state = "Intercept" and engaged = false and flee = false][
    ...
    if count out-chase-neighbors in-radius r_engage > 0 or count in-chase-neighbors in-radius r_engage > 0 [

      ifelse count out-chase-neighbors in-radius r_engage > 0 [
        let target one-of out-chase-neighbors in-radius r_engage
        create-battle-with target
      ]
      [
        let target one-of in-chase-neighbors in-radius r_engage
        create-battle-with target
      ]
      ; set [engaged] of target true
      ; set engaged true
  ...
  ask battles [
    ...
    ask attacker [
      ...
      ask defender [
        ...
        if class = 1 and (random 10 > p_hit)
